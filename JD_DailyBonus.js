...
var Key = 'pt_pin=jd_qlCcujmMNgrX;pt_key=AAJghr18ADD_ioVsW8tuV9RTQgagPZwettzBBrh5t5gyLYzK7p22V74HQwOHhwgafHOGKFco0PM;'; //单引号内自行填写您抓取的Cookie
...
var stop = '666'; //自定义延迟签到, 单位毫秒. 默认分批并发无延迟; 该参数接受随机或指定延迟(例: '2000'则表示延迟2秒; '2000-5000'则表示延迟最小2秒,最大5秒内的随机延迟), 如填入延迟则切换顺序签到(耗时较长), Surge用户请注意在SurgeUI界面调整脚本超时; 注: 该参数Node.js或JSbox环境下已配置数据持久化, 留空(var stop = '')即可清除.
